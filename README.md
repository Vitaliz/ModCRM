...
modCRM is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/modCRM.git ./`

Then, credate the target directory where you want to create the file.

Then, navigate to the directory modCRM is now in, and do this:
...
Now, you'll want to change references to modCRM in the files in your
new copied-from-modCRM repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'modCRM' to whatever the
name of your component is.

## Copyright Information

modCRM is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of modCRM the ability to modify, distribute
and use modCRM in MODx development as they see fit, as long as attribution
